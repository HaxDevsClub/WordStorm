...
public class RenderItem implements IResourceManagerReloadListener {
   ...
   private void func_175045_a(IBakedModel p_175045_1_, int p_175045_2_, ItemStack p_175045_3_) {
      ...
      var5.func_178970_b();
      var5.func_178967_a(DefaultVertexFormats.field_176599_b);
   ...
   private void func_175038_a(WorldRenderer p_175038_1_, BakedQuad p_175038_2_) {
      Vec3i var3 = p_175038_2_.func_178210_d().func_176730_m();
      p_175038_1_.func_178975_e((float)var3.func_177958_n(), (float)var3.func_177956_o(), (float)var3.func_177952_p());
   }
   ...
   private void func_175032_a(WorldRenderer p_175032_1_, List p_175032_2_, int p_175032_3_, ItemStack p_175032_4_) {
      ...
      for(Iterator var6 = p_175032_2_.iterator(); var6.hasNext(); this.func_175033_a(p_175032_1_, var7, var8)) {
         ...
         if(var5 && var7.func_178212_b()) {
            var8 = p_175032_4_.func_77973_b().func_82790_a(p_175032_4_, var7.func_178211_c());
   ...
   public boolean func_175050_a(ItemStack p_175050_1_) {
      IBakedModel var2 = this.field_175059_m.func_178089_a(p_175050_1_);
      return var2 == null?false:var2.func_177556_c();
   }

   private void func_175046_c(ItemStack p_175046_1_) {
      IBakedModel var2 = this.field_175059_m.func_178089_a(p_175046_1_);
      Item var3 = p_175046_1_.func_77973_b();
      if(var3 != null) {
   ...
   public void func_175043_b(ItemStack p_175043_1_) {
      IBakedModel var2 = this.field_175059_m.func_178089_a(p_175043_1_);
   ...
   public void func_175049_a(ItemStack p_175049_1_, EntityLivingBase p_175049_2_, ItemCameraTransforms.TransformType p_175049_3_) {
      IBakedModel var4 = this.field_175059_m.func_178089_a(p_175049_1_);
      if(p_175049_2_ instanceof EntityPlayer) {
         EntityPlayer var5 = (EntityPlayer)p_175049_2_;
         Item var6 = p_175049_1_.func_77973_b();
         ...
         if(var6 == Items.field_151112_aM && var5.field_71104_cf != null) {
            ...
            int var8 = p_175049_1_.func_77988_m() - var5.func_71052_bv();
            if(var8 >= 18) {
   ...
   protected void func_175034_a(ItemTransformVec3f p_175034_1_) {
      if(p_175034_1_ != ItemTransformVec3f.field_178366_a) {
         ...
         GlStateManager.func_179114_b(p_175034_1_.field_178364_b.y + field_175051_f, 0.0F, 1.0F, 0.0F);
         GlStateManager.func_179114_b(p_175034_1_.field_178364_b.x + field_175054_e, 1.0F, 0.0F, 0.0F);
         GlStateManager.func_179114_b(p_175034_1_.field_178364_b.z + field_175052_g, 0.0F, 0.0F, 1.0F);
         GlStateManager.func_179152_a(p_175034_1_.field_178363_d.x + field_175061_h, p_175034_1_.field_178363_d.y + field_175062_i, p_175034_1_.field_178363_d.z + field_175060_j);
      }
   ...
   public void func_175042_a(ItemStack p_175042_1_, int p_175042_2_, int p_175042_3_) {
      IBakedModel var4 = this.field_175059_m.func_178089_a(p_175042_1_);
      GlStateManager.func_179094_E();
      this.field_175057_n.func_110577_a(TextureMap.field_110575_b);
      this.field_175057_n.func_110581_b(TextureMap.field_110575_b).func_174936_b(false, false);
      GlStateManager.func_179091_B();
      ...
      GlStateManager.func_179112_b(770, 771);
      GlStateManager.func_179131_c(1.0F, 1.0F, 1.0F, 1.0F);
      this.func_180452_a(p_175042_2_, p_175042_3_, var4.func_177556_c());
      this.func_175034_a(var4.func_177552_f().field_178354_e);
   ...
   public void func_180450_b(final ItemStack p_180450_1_, int p_180450_2_, int p_180450_3_) {
      if(p_180450_1_ != null) {
         ...
         try {
            ...
            var6.func_71500_a("Item Type", new Callable() {
            ...
            var6.func_71500_a("Item Aux", new Callable() {
            ...
            var6.func_71500_a("Item NBT", new Callable() {
            ...
            var6.func_71500_a("Item Foil", new Callable() {
   ...
   public void func_180453_a(FontRenderer p_180453_1_, ItemStack p_180453_2_, int p_180453_3_, int p_180453_4_, String p_180453_5_) {
      if(p_180453_2_ != null) {
         if(p_180453_2_.field_77994_a != 1 || p_180453_5_ != null) {
            String var6 = p_180453_5_ == null?String.valueOf(p_180453_2_.field_77994_a):p_180453_5_;
            if(p_180453_5_ == null && p_180453_2_.field_77994_a < 1) {
               var6 = EnumChatFormatting.RED + String.valueOf(p_180453_2_.field_77994_a);
            }

            GlStateManager.func_179140_f();
            GlStateManager.func_179097_i();
            GlStateManager.func_179084_k();
            p_180453_1_.func_175063_a(var6, (float)(p_180453_3_ + 19 - 2 - p_180453_1_.func_78256_a(var6)), (float)(p_180453_4_ + 6 + 3), 16777215);
            GlStateManager.func_179145_e();
            GlStateManager.func_179126_j();
         }

         if(p_180453_2_.func_77951_h()) {
            int var12 = (int)Math.round(13.0D - (double)p_180453_2_.func_77952_i() * 13.0D / (double)p_180453_2_.func_77958_k());
            int var7 = (int)Math.round(255.0D - (double)p_180453_2_.func_77952_i() * 255.0D / (double)p_180453_2_.func_77958_k());
            GlStateManager.func_179140_f();
            GlStateManager.func_179097_i();
   ...
   private void func_175044_a(WorldRenderer p_175044_1_, int p_175044_2_, int p_175044_3_, int p_175044_4_, int p_175044_5_, int p_175044_6_) {
      p_175044_1_.func_178970_b();
      p_175044_1_.func_178991_c(p_175044_6_);
      p_175044_1_.func_178984_b((double)(p_175044_2_ + 0), (double)(p_175044_3_ + 0), 0.0D);
      p_175044_1_.func_178984_b((double)(p_175044_2_ + 0), (double)(p_175044_3_ + p_175044_5_), 0.0D);
      p_175044_1_.func_178984_b((double)(p_175044_2_ + p_175044_4_), (double)(p_175044_3_ + p_175044_5_), 0.0D);
      p_175044_1_.func_178984_b((double)(p_175044_2_ + p_175044_4_), (double)(p_175044_3_ + 0), 0.0D);
