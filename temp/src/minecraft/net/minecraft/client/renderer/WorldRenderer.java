...
public class WorldRenderer {
   ...
   public WorldRenderer(int p_i46275_1_) {
      ...
      this.field_179011_q.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.FLOAT, VertexFormatElement.EnumUsage.POSITION, 3));
   }
   ...
   public void func_178992_a(double p_178992_1_, double p_178992_3_) {
      if(!this.field_179011_q.func_177347_a(0) && !this.field_179011_q.func_177347_a(1)) {
         VertexFormatElement var5 = new VertexFormatElement(0, VertexFormatElement.EnumType.FLOAT, VertexFormatElement.EnumUsage.UV, 2);
   ...
   public void func_178963_b(int p_178963_1_) {
      if(!this.field_179011_q.func_177347_a(1)) {
         if(!this.field_179011_q.func_177347_a(0)) {
            this.field_179011_q.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.FLOAT, VertexFormatElement.EnumUsage.UV, 2));
         }

         VertexFormatElement var2 = new VertexFormatElement(1, VertexFormatElement.EnumType.SHORT, VertexFormatElement.EnumUsage.UV, 2);
   ...
   public void func_178984_b(double p_178984_1_, double p_178984_3_, double p_178984_5_) {
      ...
      while(var8.hasNext()) {
         ...
         switch(WorldRenderer.SwitchEnumUsage.field_178959_a[var9.func_177375_c().ordinal()]) {
         case 1:
   ...
   public void func_178980_d(float p_178980_1_, float p_178980_2_, float p_178980_3_) {
      if(!this.field_179011_q.func_177350_b()) {
         VertexFormatElement var4 = new VertexFormatElement(0, VertexFormatElement.EnumType.BYTE, VertexFormatElement.EnumUsage.NORMAL, 3);
         this.field_179011_q.func_177349_a(var4);
         this.field_179011_q.func_177349_a(new VertexFormatElement(0, VertexFormatElement.EnumType.UBYTE, VertexFormatElement.EnumUsage.PADDING, 1));
      }
   ...
   static final class SwitchEnumUsage {
      ...
      // $FF: synthetic field
      static final int[] field_178959_a = new int[VertexFormatElement.EnumUsage.values().length];
