...
public class BlockState {
   ...
   public BlockState(Block p_i45663_1_, IProperty ... p_i45663_2_) {
      ...
      while(var6.hasNext()) {
         ...
         BlockState.StateImplementation var9 = new BlockState.StateImplementation(p_i45663_1_, ImmutableMap.copyOf(var8), null);
         var3.put(var8, var9);
         var4.add(var9);
      }
   ...
   static class StateImplementation extends BlockStateBase {
      ...
      private StateImplementation(Block p_i45660_1_, ImmutableMap p_i45660_2_) {
