...
public class GuiIngame extends Gui
{
    ...
    public void renderGameOverlay(float partialTicks)
    {
        ...
        if (var15 != null)
        {
            int var10 = var15.getChatFormat().getColorIndex();
        ...
        if (var16 != null)
        {
            this.renderScoreboard(var16, var2);
        }
        ...
        if (this.mc.gameSettings.keyBindPlayerList.isKeyDown() && (!this.mc.isIntegratedServerRunning() || this.mc.thePlayer.sendQueue.getPlayerInfoMap().size() > 1 || var16 != null))
        {
            this.overlayPlayerList.updatePlayerList(true);
            this.overlayPlayerList.renderPlayerlist(var3, var12, var16);
        }
        else
        {
    ...
    public void renderExpBar(ScaledResolution p_175176_1_, int p_175176_2_)
    {
        ...
        if (this.mc.thePlayer.experienceLevel > 0)
        {
            ...
            var6 = (p_175176_1_.getScaledWidth() - this.getFontRenderer().getStringWidth(var10)) / 2;
    ...
    private void renderScoreboard(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_)
    {
        ...
        for (Iterator var7 = var21.iterator(); var7.hasNext(); var6 = Math.max(var6, this.getFontRenderer().getStringWidth(var10)))
        {
