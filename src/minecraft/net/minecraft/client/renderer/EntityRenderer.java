...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    private float getFOVModifier(float partialTicks, boolean p_78481_2_)
    {
        ...
        else
        {
            ...
            {
                float var5 = (float)((EntityLivingBase)var3).deathTime + partialTicks;
                var4 /= (1.0F - 500.0F / (var5 + 500.0F)) * 2.0F + 1.0F;
            }

            Block var6 = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, var3, partialTicks);
    ...
    private void orientCamera(float partialTicks)
    {
        ...
        {
            double var10 = (double)(this.thirdPersonDistanceTemp + (this.thirdPersonDistance - this.thirdPersonDistanceTemp) * partialTicks);
        ...
        if (!this.mc.gameSettings.debugCamEnable)
        {
            ...
            if (var2 instanceof EntityAnimal)
            {
                ...
                GlStateManager.rotate(var28.prevRotationYawHead + (var28.rotationYawHead - var28.prevRotationYawHead) * partialTicks + 180.0F, 0.0F, 1.0F, 0.0F);
            }
            else
            {
                GlStateManager.rotate(var2.prevRotationYaw + (var2.rotationYaw - var2.prevRotationYaw) * partialTicks + 180.0F, 0.0F, 1.0F, 0.0F);
    ...
    public void updateCameraAndRender(float partialTicks)
    {
        ...
        if (this.mc.inGameHasFocus && var2)
        {
            ...
            if (this.mc.gameSettings.smoothCamera)
            {
                ...
                float var8 = partialTicks - this.smoothCamPartialTicks;
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            if (this.mc.theWorld != null)
            {
                ...
                this.renderWorld(partialTicks, this.renderEndNanoTime + (long)(1000000000 / var9));
            ...
            if (this.mc.currentScreen != null)
            {
                ...
                try
                {
                    this.mc.currentScreen.drawScreen(var16, var17, partialTicks);
                }
    ...
    {
        float var2 = this.mc.theWorld.getRainStrength(partialTicks);
        ...
        if (var2 > 0.0F)
        {
            ...
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            GlStateManager.alphaFunc(516, 0.1F);
            double var10 = var3.lastTickPosX + (var3.posX - var3.lastTickPosX) * (double)partialTicks;
            double var12 = var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)partialTicks;
            double var14 = var3.lastTickPosZ + (var3.posZ - var3.lastTickPosZ) * (double)partialTicks;
    ...
    private void updateFogColor(float partialTicks)
    {
        ...
        {
            double var10 = -1.0D;
            Vec3 var12 = MathHelper.sin(var2.getCelestialAngleRadians(partialTicks)) > 0.0F ? new Vec3(var10, 0.0D, 0.0D) : new Vec3(1.0D, 0.0D, 0.0D);
            var13 = (float)var3.getLook(partialTicks).dotProduct(var12);
            ...
            if (var13 > 0.0F)
            {
                float[] var14 = var2.provider.calcSunriseSunsetColors(var2.getCelestialAngle(partialTicks), partialTicks);
        ...
        Block var21 = ActiveRenderInfo.getBlockAtEntityViewpoint(this.mc.theWorld, var3, partialTicks);

        if (this.cloudFog)
        {
            Vec3 var22 = var2.getCloudColour(partialTicks);
        ...
        double var23 = (var3.lastTickPosY + (var3.posY - var3.lastTickPosY) * (double)partialTicks) * var2.provider.getVoidFogYFactor();
        ...
        if (this.bossColorModifier > 0.0F)
        {
            var24 = this.bossColorModifierPrev + (this.bossColorModifier - this.bossColorModifierPrev) * partialTicks;
            this.fogColorRed = this.fogColorRed * (1.0F - var24) + this.fogColorRed * 0.7F * var24;
            this.fogColorGreen = this.fogColorGreen * (1.0F - var24) + this.fogColorGreen * 0.6F * var24;
            this.fogColorBlue = this.fogColorBlue * (1.0F - var24) + this.fogColorBlue * 0.6F * var24;
        }
        ...
        {
            var24 = this.getNightVisionBrightness((EntityLivingBase)var3, partialTicks);
            ...
            this.fogColorRed = this.fogColorRed * (1.0F - var24) + this.fogColorRed * var17 * var24;
            this.fogColorGreen = this.fogColorGreen * (1.0F - var24) + this.fogColorGreen * var17 * var24;
            this.fogColorBlue = this.fogColorBlue * (1.0F - var24) + this.fogColorBlue * var17 * var24;
        }

        if (this.mc.gameSettings.anaglyph)
        {
            var24 = (this.fogColorRed * 30.0F + this.fogColorGreen * 59.0F + this.fogColorBlue * 11.0F) / 100.0F;
