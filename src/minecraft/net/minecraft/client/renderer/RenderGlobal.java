...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener
{
        ...
        else
        {
            ...
            if (this.isRenderEntityOutlines())
            {
                ...
                for (var18 = 0; var18 < var17.size(); ++var18)
                {
                    ...
                    boolean var20 = this.mc.getRenderViewEntity() instanceof EntityLivingBase && ((EntityLivingBase)this.mc.getRenderViewEntity()).isPlayerSleeping();
                    boolean var21 = var19.isInRangeToRender3d(var4, var6, var8) && (var19.ignoreFrustumCheck || camera.isBoundingBoxInFrustum(var19.getEntityBoundingBox()) || var19.riddenByEntity == this.mc.thePlayer) && var19 instanceof EntityPlayer;

                    if ((var19 != this.mc.getRenderViewEntity() || this.mc.gameSettings.thirdPersonView != 0 || var20) && var21)
                    {
                        this.renderManager.renderEntitySimple(var19, partialTicks);
                    }
                }
            ...
            Iterator var25 = this.renderInfos.iterator();
            RenderGlobal.ContainerLocalRenderInformation var26;

            while (var25.hasNext())
            {
                var26 = (RenderGlobal.ContainerLocalRenderInformation)var25.next();
                Chunk var28 = this.theWorld.getChunkFromBlockCoords(var26.renderChunk.getPosition());
                Iterator var31 = var28.getEntityLists()[var26.renderChunk.getPosition().getY() / 16].iterator();

                while (var31.hasNext())
                {
                    Entity var22 = (Entity)var31.next();
                    boolean var23 = this.renderManager.shouldRender(var22, camera, var4, var6, var8) || var22.riddenByEntity == this.mc.thePlayer;

                    if (var23)
                    {
                        boolean var24 = this.mc.getRenderViewEntity() instanceof EntityLivingBase ? ((EntityLivingBase)this.mc.getRenderViewEntity()).isPlayerSleeping() : false;

                        if (var22 == this.mc.getRenderViewEntity() && this.mc.gameSettings.thirdPersonView == 0 && !var24 || var22.posY >= 0.0D && var22.posY < 256.0D && !this.theWorld.isBlockLoaded(new BlockPos(var22)))
                        {
                            continue;
                        }

                        ++this.countEntitiesRendered;
                        this.renderManager.renderEntitySimple(var22, partialTicks);
                    }

                    if (!var23 && var22 instanceof EntityWitherSkull)
                    {
                        this.mc.getRenderManager().renderWitherSkull(var22, partialTicks);
                    }
                }
            }
            ...
            RenderHelper.enableStandardItemLighting();
            var25 = this.renderInfos.iterator();
            TileEntity var32;

            while (var25.hasNext())
            {
                var26 = (RenderGlobal.ContainerLocalRenderInformation)var25.next();
                Iterator var29 = var26.renderChunk.getCompiledChunk().getTileEntities().iterator();

                while (var29.hasNext())
                {
                    var32 = (TileEntity)var29.next();
                    TileEntityRendererDispatcher.instance.renderTileEntity(var32, partialTicks, -1);
                }
            }
            ...
            while (var25.hasNext())
            {
                ...
                BlockPos var30 = var27.getPosition();
                ...
                {
                    TileEntityRendererDispatcher.instance.renderTileEntity(var32, partialTicks, var27.getPartialBlockDamage());
                }
            }
    ...
    public void setupTerrain(Entity viewEntity, double partialTicks, ICamera camera, int frameCount, boolean playerSpectator)
    {
        ...
        BlockPos var35 = new BlockPos(var13, var15 + (double)viewEntity.getEyeHeight(), var17);
        RenderChunk var20 = this.viewFrustum.getRenderChunk(var35);
        ...
        if (!var22 && this.displayListEntitiesDirty)
        {
            ...
            if (var20 == null)
            {
                ...
                for (int var26 = -this.renderDistanceChunks; var26 <= this.renderDistanceChunks; ++var26)
                {
                    for (int var27 = -this.renderDistanceChunks; var27 <= this.renderDistanceChunks; ++var27)
                    {
                        ...
                        if (var28 != null && ((ICamera)camera).isBoundingBoxInFrustum(var28.boundingBox))
                        {
                            var28.setFrameIndex(frameCount);
            ...
            else
            {
                ...
                Set var42 = this.getVisibleFacings(var35);

                if (!var42.isEmpty() && var42.size() == 1)
                {
                    Vector3f var44 = this.getViewVector(viewEntity, partialTicks);
                    EnumFacing var29 = EnumFacing.getFacingFromVector(var44.x, var44.y, var44.z).getOpposite();
                    var42.remove(var29);
                }
                ...
                {
                    if (playerSpectator && this.theWorld.getBlockState(var35).getBlock().isOpaqueCube())
                    {
                        var24 = false;
                    }
            ...
            while (!var23.isEmpty())
            {
                ...
                EnumFacing var43 = var39.facing;
                BlockPos var45 = var41.getPosition();
                ...
                for (int var31 = 0; var31 < var30; ++var31)
                {
                    ...
                    RenderChunk var33 = this.getRenderChunkOffset(var35, var45, var32);

                    if ((!var24 || !var39.setFacing.contains(var32.getOpposite())) && (!var24 || var43 == null || var41.getCompiledChunk().isVisible(var43.getOpposite(), var32)) && var33 != null && var33.setFrameIndex(frameCount) && ((ICamera)camera).isBoundingBoxInFrustum(var33.boundingBox))
                    {
                        RenderGlobal.ContainerLocalRenderInformation var34 = new RenderGlobal.ContainerLocalRenderInformation(var33, var32, var39.counter + 1, null);
        ...
        while (var37.hasNext())
        {
            ...
            if (var41.isNeedsUpdate() || var41.isCompileTaskPending() || var36.contains(var41))
            {
                this.displayListEntitiesDirty = true;
        ...
        this.chunksToUpdate.addAll(var36);
        this.mc.mcProfiler.endSection();
    }
    ...
    /**
     * Returns the neighbor chunk on the specified side.
     */
    private RenderChunk getRenderChunkOffset(BlockPos posEye, BlockPos posChunk, EnumFacing side)
    {
        BlockPos var4 = posChunk.offset(side, 16);
        return MathHelper.abs_int(posEye.getX() - var4.getX()) > this.renderDistanceChunks * 16 ? null : (var4.getY() >= 0 && var4.getY() < 256 ? (MathHelper.abs_int(posEye.getZ() - var4.getZ()) > this.renderDistanceChunks * 16 ? null : this.viewFrustum.getRenderChunk(var4)) : null);
    }
    ...
    public int renderBlockLayer(EnumWorldBlockLayer blockLayerIn, double partialTicks, int pass, Entity entityIn)
    {
        ...
        if (blockLayerIn == EnumWorldBlockLayer.TRANSLUCENT)
        {
            ...
            if (var6 * var6 + var8 * var8 + var10 * var10 > 1.0D)
            {
                ...
                while (var13.hasNext())
                {
                    ...
                    if (var14.renderChunk.compiledChunk.isLayerStarted(blockLayerIn) && var12++ < 15)
                    {
        ...
        for (int var11 = var16; var11 != var9; var11 += var17)
        {
            ...
            if (!var18.getCompiledChunk().isLayerEmpty(blockLayerIn))
            {
                ++var15;
                this.renderContainer.addRenderChunk(var18, blockLayerIn);
            }
        }
    ...
    private void renderBlockLayer(EnumWorldBlockLayer blockLayerIn)
    {
        ...
        if (OpenGlHelper.useVbo())
        {
            ...
            while (var3.hasNext())
            {
                ...
                switch (RenderGlobal.SwitchEnumUsage.VALUES[var5.ordinal()])
                {
                    case 1:
    ...
    public void renderSky(float partialTicks, int pass)
    {
        ...
        else if (this.mc.theWorld.provider.isSurfaceWorld())
        {
            ...
            Vec3 var3 = this.theWorld.getSkyColor(this.mc.getRenderViewEntity(), partialTicks);
            ...
            GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
            RenderHelper.disableStandardItemLighting();
            float[] var25 = this.theWorld.provider.calcSunriseSunsetColors(this.theWorld.getCelestialAngle(partialTicks), partialTicks);
            float var10;
            float var11;
            float var12;
            float var13;
            ...
            var23.draw();
            GlStateManager.disableTexture2D();
            float var22 = this.theWorld.getStarBrightness(partialTicks) * var10;
            ...
            double var26 = this.mc.thePlayer.getPositionEyes(partialTicks).yCoord - this.theWorld.getHorizon();
    ...
    public void renderClouds(float partialTicks, int pass)
    {
        if (this.mc.theWorld.provider.isSurfaceWorld())
        {
            ...
            else
            {
                ...
                var12 = 4.8828125E-4F;
                double var26 = (double)((float)this.cloudTickCounter + partialTicks);
                double var15 = this.mc.getRenderViewEntity().prevPosX + (this.mc.getRenderViewEntity().posX - this.mc.getRenderViewEntity().prevPosX) * (double)partialTicks + var26 * 0.029999999329447746D;
                ...
                if (!(var20 instanceof BlockChest) && !(var20 instanceof BlockEnderChest) && !(var20 instanceof BlockSign) && !(var20 instanceof BlockSkull))
                {
                    ...
                    else
                    {
                        ...
                        if (var21.getBlock().getMaterial() != Material.air)
                        {
                            ...
                            var24.renderBlockDamage(var21, var13, var23, this.theWorld);
                        }
                    }
                }
            }
    ...
    private EntityFX spawnEntityFX(int p_174974_1_, boolean ignoreRange, double p_174974_3_, double p_174974_5_, double p_174974_7_, double p_174974_9_, double p_174974_11_, double p_174974_13_, int ... p_174974_15_)
    {
        if (this.mc != null && this.mc.getRenderViewEntity() != null && this.mc.effectRenderer != null)
        {
            ...
            {
                double var23 = 16.0D;
                return var17 * var17 + var19 * var19 + var21 * var21 > 256.0D ? null : (var16 > 1 ? null : this.mc.effectRenderer.spawnEffectParticle(p_174974_1_, p_174974_3_, p_174974_5_, p_174974_7_, p_174974_9_, p_174974_11_, p_174974_13_, p_174974_15_));
            }
        }
        else
        {
        ...
        switch (sfxType)
        {
            ...
            case 2000:
                ...
                for (int var33 = 0; var33 < 10; ++var33)
                {
                    ...
                    this.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, var35, var20, var22, var24, var26, var28, new int[0]);
                }
