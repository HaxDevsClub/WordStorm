...
public class FaceBakery
{
    ...
    public BakedQuad makeBakedQuad(Vector3f posFrom, Vector3f posTo, BlockPartFace face, TextureAtlasSprite sprite, EnumFacing facing, ModelRotation modelRotationIn, BlockPartRotation partRotation, boolean uvLocked, boolean shade)
    {
        ...
        return new BakedQuad(var10, face.tintIndex, var11);
    }
    ...
    private float[] getPositionsDiv16(Vector3f pos1, Vector3f pos2)
    {
        ...
        var3[EnumFaceDirection.Constants.WEST_INDEX] = pos1.x / 16.0F;
        var3[EnumFaceDirection.Constants.DOWN_INDEX] = pos1.y / 16.0F;
        var3[EnumFaceDirection.Constants.NORTH_INDEX] = pos1.z / 16.0F;
        var3[EnumFaceDirection.Constants.EAST_INDEX] = pos2.x / 16.0F;
        var3[EnumFaceDirection.Constants.UP_INDEX] = pos2.y / 16.0F;
        var3[EnumFaceDirection.Constants.SOUTH_INDEX] = pos2.z / 16.0F;
        return var3;
    }
    ...
    {
        EnumFacing var11 = modelRotationIn.rotateFace(facing);
