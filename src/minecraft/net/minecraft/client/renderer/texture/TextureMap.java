...
public class TextureMap extends AbstractTexture implements ITickableTextureObject
{
    ...
    public void loadTextureAtlas(IResourceManager resourceManager)
    {
        ...
        while (var6.hasNext())
        {
            ...
            try
            {
                IResource var11 = resourceManager.getResource(var10);
                ...
                if (var13 != null)
                {
                    ...
                    while (var39.hasNext())
                    {
                        ...
                        if (var16 > 0 && var16 < var12.length - 1 && var12[var16] == null)
                        {
                            ...
                            try
                            {
                                var12[var16] = TextureUtil.readBufferedImage(resourceManager.getResource(var17).getInputStream());
                            }
    ...
    public TextureAtlasSprite registerSprite(ResourceLocation location)
    {
        ...
        {
            TextureAtlasSprite var2 = (TextureAtlasSprite)this.mapRegisteredSprites.get(location);
