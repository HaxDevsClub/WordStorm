...
public class TextureUtil
{
    ...
    private static int blendColors(int p_147943_0_, int p_147943_1_, int p_147943_2_, int p_147943_3_, boolean p_147943_4_)
    {
        if (!p_147943_4_)
        {
            int var13 = blendColorComponent(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 24);
            int var14 = blendColorComponent(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 16);
            int var15 = blendColorComponent(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 8);
            int var16 = blendColorComponent(p_147943_0_, p_147943_1_, p_147943_2_, p_147943_3_, 0);
        ...
        else
        {
            ...
            {
                if (mipmapBuffer[var9] >> 24 != 0)
                {
                    var5 += (float)Math.pow((double)((float)(mipmapBuffer[var9] >> 24 & 255) / 255.0F), 2.2D);
                    var6 += (float)Math.pow((double)((float)(mipmapBuffer[var9] >> 16 & 255) / 255.0F), 2.2D);
                    var7 += (float)Math.pow((double)((float)(mipmapBuffer[var9] >> 8 & 255) / 255.0F), 2.2D);
                    var8 += (float)Math.pow((double)((float)(mipmapBuffer[var9] >> 0 & 255) / 255.0F), 2.2D);
                }
            }
