...
public class BlockModelRenderer
{
    ...
    public boolean renderModel(IBlockAccess blockAccessIn, IBakedModel modelIn, IBlockState blockStateIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides)
    {
        ...
        try
        {
            Block var8 = blockStateIn.getBlock();
            return var7 ? this.renderModelAmbientOcclusion(blockAccessIn, modelIn, var8, blockPosIn, worldRendererIn, checkSides) : this.renderModelStandard(blockAccessIn, modelIn, var8, blockPosIn, worldRendererIn, checkSides);
        }
    ...
    public boolean renderModelAmbientOcclusion(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides)
    {
        ...
        for (int var13 = 0; var13 < var12; ++var13)
        {
            ...
            List var15 = modelIn.getFaceQuads(var14);
            ...
            if (!var15.isEmpty())
            {
                ...
                {
                    this.renderModelAmbientOcclusionQuads(blockAccessIn, blockIn, blockPosIn, worldRendererIn, var15, var8, var9, var10);
                    var7 = true;
                }
            }
        }
        ...
        if (var17.size() > 0)
        {
            this.renderModelAmbientOcclusionQuads(blockAccessIn, blockIn, blockPosIn, worldRendererIn, var17, var8, var9, var10);
            var7 = true;
        }
    ...
    public boolean renderModelStandard(IBlockAccess blockAccessIn, IBakedModel modelIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, boolean checkSides)
    {
        ...
        for (int var11 = 0; var11 < var10; ++var11)
        {
            ...
            List var13 = modelIn.getFaceQuads(var12);
            ...
            if (!var13.isEmpty())
            {
                ...
                if (!checkSides || blockIn.shouldSideBeRendered(blockAccessIn, var14, var12))
                {
                    ...
                    this.renderModelStandardQuads(blockAccessIn, blockIn, blockPosIn, var12, var15, false, worldRendererIn, var13, var8);
                    var7 = true;
                }
            }
        }

        List var16 = modelIn.getGeneralQuads();

        if (var16.size() > 0)
        {
            this.renderModelStandardQuads(blockAccessIn, blockIn, blockPosIn, (EnumFacing)null, -1, true, worldRendererIn, var16, var8);
            var7 = true;
        }
    ...
    private void renderModelAmbientOcclusionQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, WorldRenderer worldRendererIn, List listQuadsIn, float[] quadBounds, BitSet boundsFlags, BlockModelRenderer.AmbientOcclusionFace aoFaceIn)
    {
        ...
        {
            long var16 = MathHelper.getPositionRandom(blockPosIn);
        ...
        for (Iterator var22 = listQuadsIn.iterator(); var22.hasNext(); worldRendererIn.putPosition(var9, var11, var13))
        {
            ...
            if (var17.hasTintIndex())
            {
                int var18 = blockIn.colorMultiplier(blockAccessIn, blockPosIn, var17.getTintIndex());
    ...
    private void fillQuadBounds(Block blockIn, int[] vertexData, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags)
    {
        ...
        {
            var13 = Float.intBitsToFloat(vertexData[var12 * 7]);
            float var14 = Float.intBitsToFloat(vertexData[var12 * 7 + 1]);
            float var15 = Float.intBitsToFloat(vertexData[var12 * 7 + 2]);
    ...
    private void renderModelStandardQuads(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing faceIn, int brightnessIn, boolean ownBrightness, WorldRenderer worldRendererIn, List listQuadsIn, BitSet boundsFlags)
    {
        ...
        {
            int var17 = blockPosIn.getX();
            int var18 = blockPosIn.getZ();
        ...
        for (Iterator var23 = listQuadsIn.iterator(); var23.hasNext(); worldRendererIn.putPosition(var10, var12, var14))
        {
            BakedQuad var24 = (BakedQuad)var23.next();

            if (ownBrightness)
            {
                this.fillQuadBounds(blockIn, var24.getVertexData(), var24.getFace(), (float[])null, boundsFlags);
                brightnessIn = boundsFlags.get(0) ? blockIn.getMixedBrightnessForBlock(blockAccessIn, blockPosIn.offset(var24.getFace())) : blockIn.getMixedBrightnessForBlock(blockAccessIn, blockPosIn);
            }

            worldRendererIn.addVertexData(var24.getVertexData());
            worldRendererIn.putBrightness4(brightnessIn, brightnessIn, brightnessIn, brightnessIn);

            if (var24.hasTintIndex())
            {
                int var25 = blockIn.colorMultiplier(blockAccessIn, blockPosIn, var24.getTintIndex());
    ...
    class AmbientOcclusionFace
    {
        ...
        public void updateVertexBrightness(IBlockAccess blockAccessIn, Block blockIn, BlockPos blockPosIn, EnumFacing facingIn, float[] quadBounds, BitSet boundsFlags)
        {
            ...
            float var17 = blockAccessIn.getBlockState(var9).getBlock().getAmbientOcclusionLightValue();
            float var18 = blockAccessIn.getBlockState(var10).getBlock().getAmbientOcclusionLightValue();
            float var19 = blockAccessIn.getBlockState(var11).getBlock().getAmbientOcclusionLightValue();
            float var20 = blockAccessIn.getBlockState(var12).getBlock().getAmbientOcclusionLightValue();
            ...
            else
            {
                ...
                var25 = blockAccessIn.getBlockState(var33).getBlock().getAmbientOcclusionLightValue();
            ...
            else
            {
                ...
                var26 = blockAccessIn.getBlockState(var33).getBlock().getAmbientOcclusionLightValue();
            ...
            else
            {
                ...
                var27 = blockAccessIn.getBlockState(var33).getBlock().getAmbientOcclusionLightValue();
            ...
            else
            {
                ...
                var28 = blockAccessIn.getBlockState(var33).getBlock().getAmbientOcclusionLightValue();
