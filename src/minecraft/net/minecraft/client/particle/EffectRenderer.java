        ...
        if (state.getBlock().getMaterial() != Material.air)
        {
            ...
            for (int var4 = 0; var4 < var3; ++var4)
            {
                for (int var5 = 0; var5 < var3; ++var5)
                {
                    ...
                    {
                        double var7 = (double)pos.getX() + ((double)var4 + 0.5D) / (double)var3;
                        double var9 = (double)pos.getY() + ((double)var5 + 0.5D) / (double)var3;
                        double var11 = (double)pos.getZ() + ((double)var6 + 0.5D) / (double)var3;
